# -*- coding: utf-8 -*-
"""
Created on Tue Mar 15 10:50:16 2022
...
if __name__ == '__main__':
   ...
   df = pd.read_excel('E:\\dataset\\Spotify\\Spotify_Release_Origin_O.xlsx','Sheet1')
   df = df.dropna()
   ...
   for s_list in lists:
       ...
       for sentence in s_list:
           j = j + 1
           dic["version"].append(df['version'][i])
   ...
   df = df.dropna()
   df = df.reset_index(drop=True)
   dataFrame.to_excel("Spotify_Release_Sentences_2.xlsx")